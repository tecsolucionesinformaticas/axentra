...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "オフになりました"),
        ("Language", "言語"),
        ("Keep Axentra background service", "Axentra バックグラウンドサービスを維持"),
        ...
        ("floating_window_tip", "Axentra のバックグラウンドサービスを維持するために使用されます。"),
