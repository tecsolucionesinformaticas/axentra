...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "꺼짐"),
        ("Language", "언어"),
        ("Keep Axentra background service", "Axentra 백그라운드 서비스 유지"),
        ...
        ("floating_window_tip", "Axentra 백그라운드 서비스를 유지하는 데 도움이 됩니다"),
