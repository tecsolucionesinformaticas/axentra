...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep Axentra background service", "Giữ dịch vụ Axentra chạy nền"),
        ...
        ("floating_window_tip", "Giữ Axentra trên cùng"),
