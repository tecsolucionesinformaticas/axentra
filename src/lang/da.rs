...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep Axentra background service", "Behold Axentra baggrundstjeneste"),
        ...
        ("floating_window_tip", "Det hjælper på at Axentra baggrundstjenesten kører"),
