...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "ભાષા"),
        ("Keep Axentra background service", "Axentra બેકગ્રાઉન્ડ સેવા ચાલુ રાખો"),
        ...
        ("floating_window_tip", "બેકગ્રાઉન્ડમાં હોય ત્યારે Axentra બતાવો"),
