...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep Axentra background service", "Ponechať službu Axentra na pozadí"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu Axentra na pozadí"),
