...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Γλώσσα"),
        ("Keep Axentra background service", "Διατήρηση της υπηρεσίας παρασκηνίου του Axentra"),
        ...
        ("Show Axentra", "Εμφάνιση του Axentra"),
        ...
        ("floating_window_tip", "Βοηθά στη διατήρηση της υπηρεσίας παρασκηνίου Axentra"),
        ...
        ("About Axentra", "Πληροφορίες για το Axentra"),
