...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep Axentra background service", "را در پس زمینه نگه دارید Axentra سرویس"),
        ...
        ("floating_window_tip", "کمک می کند Axentra این به حفظ سرویس پس زمینه"),
