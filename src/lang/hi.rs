...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "भाषा"),
        ("Keep Axentra background service", "Axentra बैकग्राउंड सेवा चालू रखें"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान Axentra को दिखाएं"),
        ...
        ("About Axentra", "Axentra के बारे में"),
