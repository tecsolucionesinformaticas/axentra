...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Dil"),
        ("Keep Axentra background service", "Axentra arka plan hizmetini sürdürün"),
        ...
        ("floating_window_tip", "Axentra arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About Axentra", "Axentra Hakkında"),
