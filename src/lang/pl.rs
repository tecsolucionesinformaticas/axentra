...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Język"),
        ("Keep Axentra background service", "Zachowaj usługę Axentra w tle"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę Axentra w tle"),
