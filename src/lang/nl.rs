...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Taal"),
        ("Keep Axentra background service", "Axentra achtergronddienst behouden"),
        ...
        ("floating_window_tip", "Helpt Axentra op de achtergrond actief te houden"),
