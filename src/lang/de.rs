...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Sprache"),
        ("Keep Axentra background service", "Axentra im Hintergrund ausführen"),
        ...
        ("floating_window_tip", "Es hilft dabei, Axentra im Hintergrund auszuführen."),
