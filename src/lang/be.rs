...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Мова"),
        ("Keep Axentra background service", "Захаваць фонавую службу Axentra"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу Axentra"),
