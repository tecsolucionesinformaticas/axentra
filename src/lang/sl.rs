...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Jezik"),
        ("Keep Axentra background service", "Ohrani Axentraovo storitev v ozadju"),
        ...
        ("floating_window_tip", "Pomaga pri Axentra storitvi v ozadju"),
