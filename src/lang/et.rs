...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Keel"),
        ("Keep Axentra background service", "Säilita Axentrai taustateenus"),
        ...
        ("floating_window_tip", "See aitab säilitada Axentrai taustateenust."),
