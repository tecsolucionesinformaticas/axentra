...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Bahasa"),
        ("Keep Axentra background service", "Pertahankan Axentra berjalan pada service background"),
        ...
        ("Show Axentra", "Tampilkan Axentra"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service Axentra agar tetap aktif"),
