...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep Axentra background service", "Dejar Axentra como Servicio en 2do plano"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de Axentra de fondo"),
        ...
        ("About Axentra", "Acerca de Axentra"),
