...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep Axentra background service", "Saglabāt Axentra fona servisu"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt Axentra fona servisu"),
