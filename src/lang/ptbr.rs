...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Idioma"),
        ("Keep Axentra background service", "Manter o serviço do Axentra executando em segundo plano"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço Axentra em segundo plano"),
