...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep Axentra background service", "Mantendu Axentra atzeko planoko zerbitzu bezala"),
        ...
        ("floating_window_tip", "Axentra atzeko planoko zerbitzua mantentzen laguntzen du"),
