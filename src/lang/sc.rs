...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep Axentra background service", "Mantene su servìtziu de Axentra in s'isfundu"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de Axentra"),
        ...
        ("About Axentra", "Informatziones subra de Axentra"),
