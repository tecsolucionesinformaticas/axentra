...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep Axentra background service", "Zachovat službu Axentra na pozadí"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu Axentra na pozadí"),
