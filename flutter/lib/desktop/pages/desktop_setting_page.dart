...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About Axentra'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://tecsi.com.ar/privacidad');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://tecsi.com.ar');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
...
class _WaylandCardState extends State<WaylandCard> {
  ...
  // On a native install this is typically "axentra.desktop"; on Flatpak it is usually
